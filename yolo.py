...
class YOLO(object):
    _defaults = {
        # "model_path"        : 'logs/ep002-loss11.914-val_loss9.666.h5',
        "model_path":           'model_data/ep003.h5',
        # "model_path":        'model_data/final_model.h5',
        "anchors_path"      : 'model/yolo_anchors.txt',
        "classes_path"      : 'model/new_classes.txt',
        "score"             : 0.5,
        "iou"               : 0.3,
        "max_boxes"         : 100,
    ...
    #   初始化yolo
    #---------------------------------------------------#
    def __init__(self, model_path='model_data/ep003.h5'):
    ...
    def detect_rects(self, image):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            label = label.encode('utf-8')
            print(label, top, left, bottom, right)
            # result.append( [ label, top, left, bottom, right ] )
